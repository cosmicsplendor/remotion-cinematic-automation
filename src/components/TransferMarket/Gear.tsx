...
const RotatingGear: React.FC<{ top: string; right: string }> = ({
  top,
  right,
}) => {
    ...
    >
      ...
      >
        <svg
          ...
          viewBox="0 0 120 120"
        >
          {/* wrap the entire main gear in a native SVG <g> rotate */}
          <g transform={`rotate(${mainRotation} 60 60)`}>
            {/* Outer gear teeth */}
        ...
        >
          {/* wrap the small gear in its own <g>, keeping your offsets */}
          <g transform={`translate(25 25) rotate(${smallRotation}) translate(-25 -25)`}>
